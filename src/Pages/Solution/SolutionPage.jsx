...
const SolutionPage = () => {
    ...
    return (
        <div className='gradient-bg-oursolutions min-h-screen'>
            ...
            <div className='flex flex-col p-14 gap-3 gradient-bg-oursolutions1'>
            ...
            <div className='flex flex-row justify-between gap-9 p-14 h-full gradient-bg-oursolutions2'>
