...
export const aboutUs = [
  {
    text1:
      "We have been established since 2016 as an IT company that is ready to provide our best innovation to advance your business.",
    text2:
      "Our experience is a form of our best achievement in providing solutions.",
    text3: "We`ve Done with more than 60 Client,",
    text4:
      "and we made a long relationship partnership with more than 5 Company in Indonesia.",
  },
];
...
export const welcomeDatas = {
  leftItems: {
    text1: "ELEVATE YOUR SKIES",
    text2: "YELLOW FLASH",
    text3:
      "Soaring to new heights with the latest in kite technology, our website is your gateway to innovation and exhilarating experiences. Harness the winds of change and elevate your kite-flying adventures with us.",
  },
  rightItems: [
    { id: 1, src: artbanner },
    { id: 2, src: artbanner1 },
...
export const serviceHome = {
  topItems: {
    text1: "Yellow Flash",
    text2:
      "Welcome to Yelow Flash's Kite String Haven. Dive into a world where innovation meets the art of flying. Our website design and solutions elevate your kite-flying experience, offering threads of creativity and seamless digital winds for your high-flying adventures.",
  },
};
    ...
    items: [
      {
        ...
        desc2:
          "Developing an application to find online tutoring service providers and private tutors for PT Les Online",
        systemFeatures: [
          {
            id: "1",
  ...
  mobileApp: {
    items: [
      ...
      },
      {
        ...
        desc2:
          "Developing an application to make it easier for customers to book online reservations in Bebek Bengil",
        systemFeatures: [
          {
            id: "1",
            name: "News or Blog",
    ...
    items: [
      {
        ...
        desc2:
          "Placing IT Support to monitors and maintains the company computer systems, installs, and configures hardware and software, and solves technical issues in PT Trihasco Utama",
    ...
    items: [
      {
        ...
        desc2:
          "A restaurant website is a business website whose purpose is to provide information on menus, services, locations and other services. It also provides directions to restaurants. It can also offer promotional discounts and special offers from restaurants.Your customers will get a clear picture of the experience the restaurant has to offer and the vibe guests can expect.",
        systemFeatures: [
          {
            id: "1",
  ...
  mainMenu: [
    {
      id: 1,
      title: "About",
      url: "https://reaplicate-ganeshcom-6r1s643t1-fahrezaraharjo.vercel.app/about",
    },
...
export const products = [
  ...
  },
  {
    ...
    title: "SION App",
    images: [sion],
    description: "Simple way to manage payments for school & others.",
  },
  {
    id: 3,
    title: "Dimedika.id",
    images: [dimedika],
    description: "The future of digital healthcare super apps.",
  },
  {
    id: 4,
    title: "Keacara.com",
...
export const tabsData = [
  {
    ...
    photo: service1,
    paragraph:
      "We develop responsive web-based applications on various platforms, with interactive design displays, powerful functionality, and dynamic software..",
  },
  {
    title: "Mobile App",
    photo: service2,
    paragraph:
      "We design a mobile app system that supports various existing operating systems and is user friendly, where you can interact adaptively with anyone..",
  },
  {
    title: "IT Masterplan",
    photo: service3,
  ...
  },
  {
    ...
    photo: service4,
    paragraph:
      "We work with different types of clients. For us, your website is not only your digital presence but also a strong digital brand through a personalized website that visitors will love.",
  },
  {
    title: "Startup Partnership",
    photo: service5,
    paragraph:
      "Partners with us. We fine tune each innovation program to enable corporate/startup collaboration and leapfrog competition by innovating faster.",
  },
];
