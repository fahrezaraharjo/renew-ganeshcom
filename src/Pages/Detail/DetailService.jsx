            ...
            <div className='container mx-auto px-4 pt-28 pb-24'>
                <div className='flex w-full flex-row p-8'>
                    ...
                    <div className='w-1/2 flex justify-center items-center'>
                        <img src={item.img} className='shadowcard object-cover w-full h-full' />
                    </div>
                </div>
                        ...
                        {item.systemFeatures.map(feature => (
                            ...
                            >
                                <div className='w-1/2 h-[400px] rounded-md'>
                                    <img className='mb-6 object-fill rounded-md h-full w-full' src={feature.img} alt={feature.name} />
                                </div>
